...
<div class="w3-row w3-section">
  ...
  <div class="w3-row w3-section">
    ...
    <div class="w3-reset">
      <input class="w3-input w3-border w3-round-large" name="txtCPF" type="text" placeholder="Login CPF (ex. : 33333333333)" required>
    </div>
  </div>
  ...
  <div class="w3-row w3-section">
    <div class="w3-col" style="width: 11%;"><i class="w3-xxlarge fa fa-envelope"></i></div>
    <div class="w3-reset">
      <input class="w3-input w3-border w3-round-large" name="txtEmail" type="text" placeholder="Email" required>
    </div>
  </div>
