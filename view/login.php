...
<div class="w3-row w3-section">
  ...
  <div class="w3-reset">
    <input class="w3-input w3-border" name="txtLogin" type="text" placeholder="Login CPF (ex. : 33333333333)" required>
  </div>
  ...
  <div class="w3-row w3-section">
    ...
    <div class="w3-reset">
      <input class="w3-input w3-border" name="txtSenha" type="password" placeholder="Senha" required>
    </div>
  </div>
